...
const About = () => {
  return (
   <div>
     <section name='about' class="flex items-center bg-stone-100 xl:h-screen font-poppins dark:bg-[#877184]">
        <div class="justify-center flex-1 max-w-6xl py-4 mx-auto lg:py-6 md:px-6">
            <div class="flex flex-wrap ">
                ...
                <div class="w-full px-6 mb-10 lg:w-1/2 lg:mb-0 ">
                    ...
                    Bienvenue chez Esthetic Du Monde! Je suis Elia Botela, esthéticienne diplômée à Toulouse depuis 2013. Je vous offre une gamme complète de prestations, de la manucure à l'épilation, pour sublimer votre beauté et votre bien-être. Découvrez nos services de qualité et réservez votre moment de détente dès maintenant ! Au plaisir de vous accueillir chez nous.
                    </p>
                    <a href="pres"
